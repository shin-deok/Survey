...
function PostgresDBAdapter() {
  ...
  function addSurvey(name, callback) {
    console.log("## addSurvey () -- dbadapter.js ##");
    db
  ...
  function postResults(postId, json, callback) {
    console.log("## postResults () -- dbadapter.js ##");
    db
  ...
  function getResults(postId, callback) {
    console.log("## getResults () -- dbadapter.js ##");
    db
  ...
  function storeSurvey(id, json, callback) {
    console.log("## storeSurvey () -- dbadapter.js ##");
    db
  ...
  function getSurveys(callback) {
    console.log("## getSurveys () -- dbadapter.js ##");
    var surveys = {
      MySurvey1: {
        pages: [
          {
    ...
    getObjectFromStorage("surveys", function(objects) {
      console.log("## getObjectFromStorage () -- dbadapter.js ##");
